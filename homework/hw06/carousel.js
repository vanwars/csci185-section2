...
function showImage() {
    ...
    // 1. target the img element and change it's src to 
    // the image inside photos that is at slot idx

    // 2. target the caption and tell the user which 
    // photo they're looking at
...
function forward() {
    console.log('forward');
    // figure out how to use an if/else statement wrap around
    ++idx;
    showImage();
}
